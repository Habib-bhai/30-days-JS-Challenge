...
// elem.classList.add("new-class")  // TASK 8


// elem.classList.remove("new-class")  // TASK 9

// Activity.NO.5 : Event Handling
// let btn = document.body.querySelector(".btn")   // TASK 10
...
// let heading: HTMLElement = document.querySelector(".header") as HTMLElement  // TASK 11
